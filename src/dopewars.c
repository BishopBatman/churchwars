...
struct NAMES DefaultNames = {
  ...
  N_("Missing Pauline Letter"),
  /* Word used for two or more guns */
  N_("Missing Pauline Letters"),
...
/* Default price range for hiring clerics (2k-5k). Renamed from the old "Bitch"
...
{&ClericArmor, NULL, NULL, NULL, NULL, "ClericArmor",
  ...
  {NULL, NULL, NULL, &StaticGun.Name, NULL, "Name",
   N_("Name of each Missing Pauline Letter"),
   (void **)(&Gun), &StaticGun,
   sizeof(struct GUN), "Missing Pauline Letter", &NumGun, NULL, FALSE, 0, 0},
  {NULL, NULL, &(StaticGun.Price), NULL, NULL, "Price",
   N_("Price of each Missing Pauline Letter"),
   (void **)(&Gun), &StaticGun,
   sizeof(struct GUN), "Missing Pauline Letter", &NumGun, NULL, FALSE, 0, 0},
  {&(StaticGun.Space), NULL, NULL, NULL, NULL, "Space",
   N_("Space taken by each Missing Pauline Letter"),
   (void **)(&Gun), &StaticGun,
   sizeof(struct GUN), "Missing Pauline Letter", &NumGun, NULL, FALSE, 0, -1},
  {&(StaticGun.Damage), NULL, NULL, NULL, NULL, "Damage",
   N_("Damage done by each Missing Pauline Letter"),
   (void **)(&Gun), &StaticGun,
   sizeof(struct GUN), "Missing Pauline Letter", &NumGun, NULL, FALSE, 0, -1},
...
{NULL, NULL, &Prices.Spy, NULL, NULL, "Prices.Spy",
   N_("Base cost for a cleric to spy on the enemy"),
   NULL, NULL, 0, "", NULL, NULL, FALSE, 0, -1},
{NULL, NULL, &Prices.Tipoff, NULL, NULL, "Prices.Tipoff",
   N_("Base cost for a cleric to tipoff the cops to an enemy"),
   NULL, NULL, 0, "", NULL, NULL, FALSE, 0, -1},
